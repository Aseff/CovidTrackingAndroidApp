...
import com.example.covid19.Activities.TrackCountry;
...
public class CountryAdapter extends ArrayAdapter<CountryModel> {
    ...
    public CountryAdapter(@NonNull Context context, List<CountryModel> countryModelsList) {
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                TrackCountry.country_list = (List<CountryModel>) results.values;
