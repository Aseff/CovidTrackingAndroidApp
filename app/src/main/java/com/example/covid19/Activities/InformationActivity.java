...
public class InformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        track_button=findViewById(R.id.btnTrack);


        simpleArcLoader = findViewById(R.id.loader);
        scrollView = findViewById(R.id.scrollStats);
        pieChart = findViewById(R.id.anychart);
    ...
    private void fetchData() {
        ...
        RequestQueue query_request = Volley.newRequestQueue(this);
        query_request.add(request);
            ...
            public void goToCountries(){
                track_button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent=new Intent(getApplicationContext(),TrackCountry.class);
